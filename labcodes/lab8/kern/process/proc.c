...
alloc_proc(void) {
     ...
     */
     //LAB5 2011012162 : (update LAB4 steps)
    /*
     * below fields(add in LAB5) in proc_struct need to be initialized  
     *       uint32_t wait_state;                        // waiting state
     *       struct proc_struct *cptr, *yptr, *optr;     // relations between processes
     */
     //LAB6 2011012162 : (update LAB5 steps)
    /*
     ...
     */
     //LAB8:EXERCISE2 2011012162 HINT:need add some code to init fs in proc_struct, ...
    ...
    //Lab6
    proc->rq = 0;
    proc->run_link.prev = 0;
    proc->run_link.next = 0;
    proc->time_slice = 0;
...
do_fork(uint32_t clone_flags, uintptr_t stack, struct trapframe *tf) {
    ...
    ret = -E_NO_MEM;
    //LAB4:EXERCISE2 2011012162
    //LAB8:EXERCISE2 2011012162  HINT:how to copy the fs in parent's proc_struct?
    /*
